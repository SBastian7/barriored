        ...
        <section>
            <div className="flex items-end justify-between mb-8 border-b-4 border-black pb-2">
                <h2 className="text-3xl md:text-4xl font-heading font-black uppercase italic tracking-tighter flex items-center gap-3">
                    <div className="w-10 h-10 border-2 border-black bg-primary flex items-center justify-center -rotate-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                        <Megaphone className="h-6 w-6 text-white" />
                    </div>
                    Anuncios
                </h2>
                <Link
                    href={`/${communitySlug}/community/announcements`}
