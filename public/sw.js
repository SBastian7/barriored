...
(() => {
  ...
  var Serwist = class {
    constructor({ precacheEntries, precacheOptions, skipWaiting = false, importScripts, navigationPreload = false, cacheId, clientsClaim: clientsClaim$1 = false, runtimeCaching: runtimeCaching2, offlineAnalyticsConfig, disableDevLogs: disableDevLogs$1 = false, fallbacks, requestRules } = {}) {
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  var runtimeCaching = [
    ...
    {
      matcher: ({ url }) => url.origin.includes("supabase.co") && url.pathname.includes("/rest/"),
    ...
    {
      matcher: ({ url }) => url.origin === "https://images.unsplash.com",
      handler: new CacheFirst({
  ...
  self.addEventListener("push", (event) => {
    ...
    let data = {
      title: "Notificaci\xF3n de BarrioRed",
